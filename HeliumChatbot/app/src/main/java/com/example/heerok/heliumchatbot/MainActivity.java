...
import com.example.heerok.heliumchatbot.Helper.HttpDataHandler;
import com.example.heerok.heliumchatbot.Models.ChatModel;
import com.example.heerok.heliumchatbot.Models.SimsimiModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class SimsimiAPI extends AsyncTask<List<ChatModel>,Void,String> {
        ...
        protected String doInBackground(List<ChatModel>... params) {
            String url = String.format("http://sandbox.api.simsimi.com/request.p?key=%s&lc=en&ft=1.0&text=%s",getString(R.string.simsimi_api_key),text);
            models = params[0];
