 ...
 */
public class Beverages extends ListActivity {
    private ProgressDialog pDialog;

    // URL to get contacts JSON
    private static String url = "http://a2a.co.in/webservice2/fetch_products.php?format=json&category=Beverages";
...
// getting values from selected ListItem
    ...
    private class GetProducts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Beverages.this);
