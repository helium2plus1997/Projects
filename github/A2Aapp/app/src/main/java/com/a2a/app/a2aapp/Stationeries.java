 ...
 */
public class Stationeries extends ListActivity {
    private ProgressDialog pDialog;

    // URL to get contacts JSON
    private static String url = "http://webservices.prolinktechnosoft.com/webservice2/fetch_products.php?format=json&category=Stationeries";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.stationeries);
...
// getting values from selected ListItem
    ...
    private class GetProducts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Stationeries.this);
