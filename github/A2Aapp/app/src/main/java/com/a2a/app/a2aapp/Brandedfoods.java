 ...
 */
public class Brandedfoods extends ListActivity {
    private ProgressDialog pDialog;

    // URL to get contacts JSON
    private static String url = "http://webservices.prolinktechnosoft.com/webservice2/fetch_products.php?format=json&category=Branded%20Foods";
...
// getting values from selected ListItem
    ...
    private class GetProducts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Brandedfoods.this);
