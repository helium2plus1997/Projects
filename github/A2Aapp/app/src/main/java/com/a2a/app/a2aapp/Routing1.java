 ...
 */
public class Routing1 extends AbstractRouting {
    ...
    private Routing1(Builder builder) {
    ...
    public static class Builder {
        ...
        private Routing1Listener listener;
        ...
        public Builder withListener (Routing1Listener listener) {
            this.listener = listener;
            return this;
        }

        public Routing1 build () {
    ...
    protected void dispatchOnSuccess(ArrayList<Route> route, int shortestRouteIndex) {
        super.dispatchOnSuccess(route, shortestRouteIndex);
    }
}
