...
/*
    private static String url = "http://webservices.prolinktechnosoft.com/webservice2/fetch_products.php?format=json&category=Fruits";
*/
    String url = "http://a2a.co.in/webservice2/fetch_products.php?format=json&category=fruits";
    // JSON Node names
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fruits2);
...
// getting values from selected ListItem
    ...
    private class GetProducts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Fruits.this);
